...
\normalsize
\centering
\caption{Results of univariate analyses. Mean AUC values (\pm \texit{s.d.}) of univariate bagged logistic regression models on training dataset using spatial minima, mean, or maxima of rainfall and temperature.}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{trendsAcrossSpace}
