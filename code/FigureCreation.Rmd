...
I'm calculating the variance per municipality to get a measure of "flickering". The variance is calculated on the probablity (that is, the rescaled value based on a contsant c, the frequency of positive cases in the dataset).
