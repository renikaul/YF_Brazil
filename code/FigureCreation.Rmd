...
```{r}
#pdf(file = "../data_out/MS_results/figures/manuscript/PercentileMap.pdf", width = 6.69, height = 4.75, family = "sans")

tiff(file = "../data_out/MS_results/figures/manuscript/PercentileMap.tiff", width = 170, height = 110, units = "mm", res = 250, family = "sans", compression = "lzw") #to get less than 10 MB
...
perc.map <- ggplot() +
  ...
  scale_fill_distiller(palette = "OrRd", direction = 1, type = "seq",
                     guide = guide_colorbar(
                       title = "Percentile Rank of\nYellow Fever Spillover",
                       direction = "vertical",
                       title.position = 'top',
  ...
  coord_sf(xlim = c(-74, -34.78), ylim = c(-33.8, 5.3), datum = NA) +
  my_theme_map() +
  ggsn::scalebar(data = bb2, dist = 400, dd2km = T,
           model = "WGS84", st.size = 1.5, height= 0.03, 
           facet.var = c("monthLabel"), facet.lev = c("Jan"),
           location = "bottomright"
           )
perc.map

north2(perc.map, x = 0.87, y = 0.2, scale = 0.1, symbol = 14)
