...
splitMap <- ggplot(data = nhp.split.map) +
  geom_sf(aes(fill = above5split), alpha = 0.8) + 
...
histPlot <- ggplot(data = primRichness) +
  geom_histogram(aes(x=spRich), binwidth = 1, fill = c(rep(lrrCol, 6), rep(hrrCol,  17)), alpha = 0.8) +
  ylab("Log(Observations)") +
...
pdf(file = "figures/manuscript/nhpSplitDist.pdf", width = 3.3, height = 3.3, family = "sans") 
...
pdf("figures/manuscript/VarImpMedian.pdf")
plot(b3)
dev.off()
```
...
tiff("figures/manuscript/RankMedian.tiff")
plot(p)
dev.off()
...
```{r}
#pdf(file = "figures/manuscript/PercentileMap.pdf", width = 6.69, height = 4.75, family = "sans")

tiff(file = "figures/manuscript/PercentileMap.tiff", width = 2007, height = 1425, units = "px", res = 300, family = "sans", compression = "lzw")
...
```{r}
#pdf(file = "figures/manuscript/LatticePlot.pdf", width = 6.69, height = 4.75, family = "sans")

tiff(file = "figures/manuscript/LatticePlot.tiff", width = 2007, height = 1425, units = "px", res = 300, family = "sans", compression = "lzw")
