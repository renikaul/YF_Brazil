...
We want to explore how the predictions rank, noting where known positives fall out. This plot plots until the lowest ranked known positive, plus a little more past that (10% of oringal included). Because there are 622720 predictions, plotting them all would be uninterpretable.
...
The lowest prediction for a known case is `r minTrue`. `r nrow(predRank)` instances fall above this, out of a total of `r nrow(predictions)`.