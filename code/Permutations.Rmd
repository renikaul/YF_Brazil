...
#Temperal split
TPermFullModel <- readRDS("../data_out/TempSplit/PermFullModel.rds")
TPermPoplessModel <- readRDS("../data_out/TempSplit/PermPoplessModel.rds")
