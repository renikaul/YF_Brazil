...
```{r}
png(file = "figures/poster/seasonalityTimeSeriesSquare.png", width = 2000, height = 2000, units = "px", res = 300)
...
for (i in 1:max(pred.map.all$month.no)){
  ...
  if(is_empty(plot.month)){plot.month == "December"}
...
cd into `figures/posters/gifs`
CMDLINE: `convert -delay 50 *.png \ predictionsAll.gif`