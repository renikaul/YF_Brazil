...
Original ebola paper used a scaled rainfall value (scaled to maximum of muni, in our case).

EVI and PET were rescaled by subtracting the mean and dividing by sd.
...
bagging<-function(form.x.y,train.pres,train.bg,new.data,iterations=176){
  ...
  #' @param train.pres dataframe containing training presence data
  #' @param train.bg dataframe containing training background data
