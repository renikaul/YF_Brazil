...
hist(log((rf[,7])+nonzero/10), main="Log transformed mean hourly rainfall") #log tranform data after adding an value an order of magnitude smaller than the smallest recorded value
...
#### Case Data
  There are a total of 117 **infected** municipalities in the entire dataset 
...
Write formula for function: 

  - log population size for year
  - monthly NDVI
  - monthly NDVI scaled to max value at that location
