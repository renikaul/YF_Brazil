...
tiff(file = "../data_out/MS_results/figures/manuscript/correlationMatrix.tiff", width = 1500, height = 1500, units = "px", res = 300, family = "sans", compression = "lzw")
...
There are some variables that have an over 0.9 correlation with each other. We created univariate logistic regressions on the whole dataset to see which are more explanatory. Note our actual model is a bagged logistic regression
