...
#save
saveRDS(tidy.mod, "../data_out/MS_results_revisions/slopeTests.rds")

#load
tidy.mod <- readRDS("../data_out/MS_results_revisions/slopeTests.rds")
```
...
```{r}
#pdf("../data_out/MS_results_revisions/figures/trendsAcrossSpace.pdf", height = 12, width = 9)

tiff(file = "../data_out/MS_results_revisions/figures/trendsAcrossSpace.tiff", width = 2007, height = 1425, units = "px", res = 300, family = "sans", compression = "lzw")
...
tiff(file = "../data_out/MS_results_revisions/figures/trendsAcrossSpace_156months.tiff", width = 2007, height = 1425, units = "px", res = 300, family = "sans", compression = "lzw")
...
month.slope %>%
  ...
  ggplot(data=.) +
    geom_sf(aes(fill = estimate), color = NA) +
    geom_sf(data = nhp.split.map, fill = NA, color = "black", size = 0.1) +
  scale_fill_gradient2(low = "#2166AC", mid = "white", high = "#B2182B", midpoint = 0, limits = c(-0.002, 0.002))
