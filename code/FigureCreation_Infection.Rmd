...
#load data
fullM <- readRDS("../data_out/MS_results_revisions/Infection/OneModel/SummaryPerm100Model500TryCatch.rds") 
lowM <- readRDS("../data_out/MS_results_revisions/Infection/LowModel/SummaryPerm100Model500TryCatch.rds")
highM <- readRDS('../data_out/MS_results_revisions/Infection/HighModel/SummaryPerm100Model500TryCatch.rds')
...
tiff("../data_out/MS_results_revisions/Infection/figures/manuscript/VarImpMedian.tiff")
plot(b3)
dev.off()

pdf("../data_out/MS_results_revisions/Infection/figures/manuscript/VarImpMedian.pdf")
plot(b3)
dev.off()
...
tiff("../data_out/MS_results_revisions/Infection/figures/manuscript/RankMedian.tiff")
plot(p)
dev.off()

pdf("../data_out/MS_results_revisions/Infection/figures/manuscript/RankMedian.pdf")
plot(p)
dev.off()
```
