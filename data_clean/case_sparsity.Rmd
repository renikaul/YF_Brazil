...
#Data run down
  ...
  The spatial data is broken down into 5564 county equivalent municipalities. Cases are reported monthly from 2001 to 2014 (12months X 14 yrs= 168 months). This means that there are a total of `r (5564*168) ` observations. Observations without cases could be considered true absences.    
...
hist(YF.space$N.months, ylab="# muni", xlab="# months with reported cases", main="")
```
