...
gdp<-cbind(gdp[,1],muni.no,gdp[,2:5])
#name dataframe columns
colnames(gdp)<-c("muni","muni.no",as.character(2010:2013))
...
gdp.new<-cbind(gdp.months[,1:2],month,gdp.months[,3:6])
#name dataframe columns
colnames(gdp.new)<-c("muni","muni.no","month",as.character(2010:2013))
